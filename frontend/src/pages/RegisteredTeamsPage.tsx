...
import { useGetPublicRegistrations, useGetRegistrationSummary } from '../hooks/useQueries';
...
export default function RegisteredTeamsPage() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-card border border-border rounded-lg p-8">
            ...
            <p className="text-muted-foreground">
              We're having trouble loading the registered teams. Please try again later.
            </p>
          </div>
        </div>
      </div>
  ...
  const maxTeams = summary?.maxTeams !== undefined ? Number(summary.maxTeams) : null;
