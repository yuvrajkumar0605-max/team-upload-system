...
import { useUploadTeamLogo, useCheckTeamLogoExists } from '../hooks/useQueries';
...
export default function TeamLogoUploadPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (exists) {
        toast.error('A logo for this team name already exists. Please use a different team name.');
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        <Card className="border-primary/20 bg-card/50 backdrop-blur-sm shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Submit your team name and logo. Each team can only upload one logo.
            </CardDescription>
          </CardHeader>
          <CardContent>
