      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-background/80">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-primary mb-4 glow-text">Tournament Results</h1>
            <p className="text-muted-foreground">Check out the latest tournament outcomes</p>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        {results.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-2">No results posted yet</h2>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto mb-8">
              {paginatedData.map((result) => (
                ...
                >
                  <div className="relative w-full overflow-hidden" style={{ aspectRatio: '4857 / 4428' }}>
                    <img
                  ...
                  <CardContent className="p-6">
                    <h3 className="text-xl font-bold text-primary mb-2 glow-text-sm">{result.title}</h3>
                    <p className="text-muted-foreground text-sm mb-4 line-clamp-3">{result.description}</p>
                    {result.link && (
                      <a
                        href={result.link}
                        target="_blank"
