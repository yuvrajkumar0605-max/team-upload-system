          ...
          <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
            <CardContent className="pt-12 pb-12">
              <Alert className="border-blue-500/50 bg-blue-500/10">
                ...
                <AlertTitle className="text-blue-500 text-xl font-bold">Schedule Coming Soon</AlertTitle>
                <AlertDescription className="text-muted-foreground mt-2">
                  The tournament schedule will be published here soon. Please check back later for updates on match timings and group schedules.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
