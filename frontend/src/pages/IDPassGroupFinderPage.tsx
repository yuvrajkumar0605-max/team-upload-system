...
import { Search, Link as LinkIcon, Loader2, AlertCircle, Users, ExternalLink } from 'lucide-react';
...
export default function IDPassGroupFinderPage() {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    await searchMutation.mutateAsync({ teamName: teamName.trim(), phoneNumber: phoneNumber.trim() });
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Enter your team name and phone number to find your assigned group link
          </p>
        </div>
        ...
        <Card className="mb-8 border-primary/20 bg-card/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>
              Enter your team name and captain's phone number to access your group assignment
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        {searchMutation.isError && (
          <Alert className="border-red-500/50 bg-red-500/10">
            ...
            <AlertDescription className="text-muted-foreground">
              You must register your team before accessing ID Pass group links. Please check your team name and phone number, or register your team first.
            </AlertDescription>
          </Alert>
        )}
          ...
          <Card className="border-primary/50 bg-card/50 backdrop-blur-sm glow-primary">
            ...
            <CardContent className="space-y-6">
              ...
              <Alert className="border-green-500/50 bg-green-500/10">
                <AlertDescription className="text-muted-foreground">
                  Your group assignment has been found! Click the link above to access your group.
                </AlertDescription>
              </Alert>
            </CardContent>
          </Card>
        ...
        {!searchMutation.data && !searchMutation.isError && !searchMutation.isPending && (
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p>Enter your team name and phone number to find your group link</p>
          </div>
        )}
      </div>
    </div>
