...
import { useGetAllAnnouncements, useCreateAnnouncement, useUpdateAnnouncement, useDeleteAnnouncement } from '../hooks/useQueries';
...
import { Megaphone, Plus, Edit, Trash2, ExternalLink, Calendar } from 'lucide-react';
import { toast } from 'sonner';
import { ExternalBlob, type Announcement } from '../backend';
        ...
        <CardContent>
          {announcements.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground text-lg mb-4">No announcements yet</p>
              <Button onClick={handleCreate} className="bg-primary hover:bg-primary/90">
                <Plus className="w-4 h-4 mr-2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {announcements.map((announcement) => (
                <Card key={announcement.id} className="border-primary/20 overflow-hidden">
                  ...
                  <CardContent className="p-4">
                    ...
                    {announcement.link && (
                      ...
                      >
                        ...
                        <span className="line-clamp-1">{announcement.link}</span>
                      </a>
                    )}
        ...
        <AlertDialogContent className="border-destructive/20 bg-card/95 backdrop-blur-sm">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete the announcement <span className="font-semibold text-foreground">"{deleteConfirmation?.title}"</span>?
              <br /><br />
              <span className="text-destructive font-medium">⚠️ This action cannot be undone.</span> The announcement will be permanently removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
