...
import { LogOut, LogIn, Shield, Users, Trophy, IdCard, Calendar, Link as LinkIcon, Upload } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate({ to: '/' })}>
            ...
            <div className="hidden md:block">
              <h1 className="text-lg sm:text-xl font-bold text-black dark:text-black">Battle of Supremacy</h1>
            </div>
          </div>
