...
export function useAddGroupLink() {
  ...
  return useMutation({
    mutationFn: async ({
      groupNumber,
      link,
    }: { groupNumber: bigint; link: string }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useSearchGroupLinkByTeam() {
  ...
  return useMutation({
    mutationFn: async ({
      teamName,
      phoneNumber,
    }: { teamName: string; phoneNumber: string }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useCreateGroupLink() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      groupNumber,
      groupLink,
    }: { groupId: bigint; groupNumber: bigint; groupLink: string }) => {
      if (!actor) throw new Error("Actor not available");
...
export function useDeleteTeamLogo() {
  ...
  return useMutation({
    mutationFn: async (_teamName: string) => {
      if (!actor) throw new Error("Actor not available");
