  ...
  const processCSVFile = async (file: File) => {
    ...
    try {
      ...
      const teamNameIdx = headers.findIndex(
        (h) =>
          (h.includes("team") && h.includes("name")) ||
          h === "teamname" ||
          h === "team_name",
      );
    ...
    <div className="space-y-6">
      ...
      <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
        <CardHeader>
          ...
          <CardDescription>
            Upload a CSV file with team names, phone numbers, and group links.
            Each group can have up to 12 teams.
          </CardDescription>
        </CardHeader>
              ...
              <div className="flex items-center justify-between p-4 border border-primary/20 rounded-lg bg-primary/5">
                <div>
                  ...
                  <p className="text-2xl font-bold text-primary">
                    {previewData.length} teams loaded
                  </p>
                </div>
                <Button
                ...
                <Table>
                  ...
                  <TableBody>
                    {previewData.slice(0, 10).map((row) => (
                      <TableRow key={row.teamName + row.phoneNumber}>
          ...
          {groupLinks.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm mt-2">
                Upload a CSV file to create group assignments
              </p>
            </div>
          ) : (
