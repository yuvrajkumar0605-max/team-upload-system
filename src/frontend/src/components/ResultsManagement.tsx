...
import type { TournamentResult as Result } from "../types";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export default function ResultsManagement() {
  ...
  const [deleteConfirmation, setDeleteConfirmation] = useState<Result | null>(
    null,
  );
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Create and manage tournament results (optimized for 4857 × 4428
                px images)
              </CardDescription>
            </div>
            <Button
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              {editingResult
                ...
                : "Fill in the details to post a new result"}
              <br />
              <span className="text-xs text-muted-foreground">
                Recommended image resolution: 4857 × 4428 pixels
              </span>
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Upload high-resolution PNG images for best quality. The image
                will be displayed with its original aspect ratio.
              </p>
