import { Calendar, Download, FileText, HardDrive, Trash2 } from "lucide-react";
...
export default function ReportsManagement() {
  ...
  const [confirmDelete, setConfirmDelete] = useState<ReportMetadata | null>(
    null,
  );
        ...
        <CardContent>
          {reports.length === 0 ? (
            <div className="text-center py-12 text-muted-foreground">
              ...
              <p className="text-sm">
                Excel reports will appear here after you export registration
                data from the Registrations tab
              </p>
            </div>
          ) : (
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="text-destructive font-medium">
                ⚠️ This will permanently delete the report file.
              </span>{" "}
