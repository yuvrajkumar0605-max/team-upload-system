...
import type { CaptainInfo, TeamMember } from "../types";
...
export default function RegistrationForm() {
  ...
  const updateMember = useCallback(
    (index: number, field: "name" | "playerId", value: string) => {
      setMembers((prev) => {
        const updated = [...prev];
        if (field === "playerId") {
        ...
        <Card className="max-w-2xl mx-auto text-center border-primary/50 glow-primary">
          <CardContent className="pt-12 pb-12">
            ...
            <p className="text-muted-foreground mb-6">
              Your team has been registered and automatically approved for the
              BOOYAH Battle of Supremacy tournament. Good luck!
            </p>
        ...
        <Card className="max-w-2xl mx-auto border-yellow-500/50">
          <CardContent className="pt-12 pb-12">
            <Alert className="border-yellow-500/50 bg-yellow-500/10">
              ...
              <AlertTitle className="text-yellow-500 text-xl font-bold">
                Registration is Currently Closed
              </AlertTitle>
              <AlertDescription className="text-muted-foreground mt-2">
                Team registration for the BOOYAH Battle of Supremacy is
                currently closed. Please check back later or contact the
                tournament organizers for more information.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card className="max-w-2xl mx-auto border-red-500/50">
          <CardContent className="pt-12 pb-12">
            <Alert className="border-red-500/50 bg-red-500/10">
              ...
              <AlertTitle className="text-red-500 text-xl font-bold">
                Registrations are Full
              </AlertTitle>
              <AlertDescription className="text-muted-foreground mt-2">
                We have reached the maximum number of team registrations (
                {maxTeams}) for the BOOYAH Battle of Supremacy tournament.
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      validationErrors.captainName ? "border-destructive" : ""
                    }
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={
                      validationErrors.captainPhone ? "border-destructive" : ""
                    }
                  />
            ...
            <div className="space-y-4 border-t border-border pt-6">
              ...
              <div className="space-y-3">
                {members.map((member, index) => (
                  <div
                    key={member.name || `member-${members.indexOf(member)}`}
                  ...
                  >
                    <div className="flex-1 grid sm:grid-cols-2 gap-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateMember(index, "playerId", e.target.value)
                        }
