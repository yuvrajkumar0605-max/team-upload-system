    ...
    <>
      <Card className="border-primary/20 bg-card/50 backdrop-blur-sm">
        <CardHeader>
          ...
          <CardDescription>
            View detailed information for all registered teams
          </CardDescription>
        </CardHeader>
        <CardContent>
          {teams.length === 0 ? (
      ...
      >
        <DialogContent className="max-w-2xl border-primary/20 bg-card/95 backdrop-blur-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete team registration information
            </DialogDescription>
          </DialogHeader>
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-primary/5 rounded-lg border border-primary/20">
                    ...
                    <Button
                      size="sm"
                      variant={
                        selectedTeam.idPassAssigned ? "destructive" : "default"
                      }
                      onClick={() =>
                        handleToggleIdPass(
                          selectedTeam.teamId,
