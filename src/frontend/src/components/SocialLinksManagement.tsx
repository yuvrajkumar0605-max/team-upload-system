        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={
                !isUrlValid(formData.instagram) ? "border-destructive" : ""
              }
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={
                !isUrlValid(formData.discord) ? "border-destructive" : ""
              }
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={
                !isUrlValid(formData.youtube) ? "border-destructive" : ""
              }
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={
                !isUrlValid(formData.whatsapp) ? "border-destructive" : ""
              }
            />
